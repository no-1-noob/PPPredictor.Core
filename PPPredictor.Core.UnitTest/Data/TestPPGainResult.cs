...
namespace UnitTests.Data
{
    ...
    public class TestPPGainResult
    {
        ...
        {
            PPGainResult ppGainResult = new PPGainResult(1, 2, 3, Enums.PPGainCalculationType.Weighted);
        ...
        public void GetDisplayPPValue()
        {
            ...
            Assert.IsTrue(ppGainResult.PpTotal == 1, "PpTotal should be 1");
            Assert.IsTrue(ppGainResult.PpGainWeighted == 2, "PpGainWeighted should be 2");
            Assert.IsTrue(ppGainResult.PpDisplayValue == ppGainResult.PpGainWeighted, "GetDisplayPPValue should give the PpGainWeighted result");
            ppGainResult = new PPGainResult(1, 2, 3, Enums.PPGainCalculationType.Raw);
            Assert.IsTrue(ppGainResult.PpDisplayValue == ppGainResult.PpGainRaw, "GetDisplayPPValue should give the PpGainRaw result");
        }
        [TestMethod]
