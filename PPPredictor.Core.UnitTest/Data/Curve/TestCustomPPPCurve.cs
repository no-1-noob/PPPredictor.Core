...
namespace UnitTests.Data.Curve
{
    ...
    public class TestCustomPPPCurve
    {
        ...
        {
            CustomPPPCurve curve = new CustomPPPCurve(new List<(double, double)>(), CurveType.BeatLeader, _testBasePPMulti);
            ...
            curve = new CustomPPPCurve(new List<(double, double)>(), CurveType.BeatLeader, _testBasePPMulti, true);
